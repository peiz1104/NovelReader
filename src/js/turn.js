...
(function ($) {
  ...
  var has3d,
    ...
    mouseEvents = { down: 'mousedown', move: 'mousemove', up: 'mouseup', over: 'mouseover', out: 'mouseout' },
    ...
    turnMethods = {
      ...
      addPage: function (element, page) {
        ...
        if (page >= 1 && page <= lastPage) {
          ...
          //Add 页码
          data.pagination[page] = $('<div class="turn-page-pagination" style="position:absolute;bottom:5px;right:6px">' + page + '/' + data.totalPages + ' </div>')
          data.pageObjs[page].append(data.pagination[page])
          // Add page
